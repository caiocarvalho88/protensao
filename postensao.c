...
int main()
{
    ...
    printf("\n************************************* \n");
    printf("Calculo de protensao para POS-TRACAO \n");
    printf("\n************************************* \n");
    x=1;
   // Etapa 03 - Cálculo da situação de pós-tração
    ...
    // Etapa 03.01 - Cálculo da situação de pré-tração por angulos
            case 1:
                ...
                if(lados==2)
                {
                    printf("\nResultado da esquerda para a direita\n");
...
void resultado(int n, float *comp, float *D, float *ang, float *da, float *dar, float *e, float *p, int cond)
{
    ...
    if (cond == 1)
    {
        printf("\nVariacao da tensao ao longo do cabo de protensao considerando atrito\n");
    }
    else
    {
        printf("\nVariacao da forca ao longo do cabo de protensao considerando atrito\n");
    }
...
Parâmetros de entrada: FILE *pont_arq
Objetivo: calcular a tabela de resultados de perda de protenção
Tipo de retorno: não tem (void)
*/
void verificar_arq(FILE *pont_arq)
...
/****** Função ancoragem *****
Parâmetros de entrada: int n, lados e cond e os floats aco, *comp, *p, *pa, *D
Objetivo: calcular a tabela de resultados de perda de protenção
Tipo de retorno: não tem (void)
*/
void ancoragem(int n, int lados, int cond, float aco, float *comp, float *p, float *pa, float *D)
{
    ...
    if(indesloc == (n-1))
    {
        ...
        {
            printf ("\nNão é recomendado usar ancoragem em ambos os lados devido a grande perda por ancoragem \n");
        }
...
void plot(float *a, float *b, float *c, int n, int cond)
{
    ...
    if (cond == 1)
    {
        printf("\nVariacao da tensao ao longo do cabo de protensao considerando atrito e a perda por ancoragem\n");
    }
    else
    {
        printf("\nVariacao da forca ao longo do cabo de protensao considerando atrito e a perda por ancoragem\n");
    }
